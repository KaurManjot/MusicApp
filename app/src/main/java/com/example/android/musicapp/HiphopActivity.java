...
public class HiphopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 1; i <= 15; i++) {
            Song song = new Song(R.drawable.hiphop, getResources().getString(R.string.song_title) +""+ i, getResources().getString(R.string.song_singer), getResources().getString(R.string.song_duration));
            songs.add(song);
        }
